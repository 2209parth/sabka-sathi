    ...
    <section className="relative overflow-hidden bg-white py-24 md:py-32">
      ...
      <div className="container relative z-10 mx-auto px-4">
        <div className="flex flex-col items-center gap-16 text-center">
          ...
          >
             <p className="mb-4 text-sm font-bold uppercase tracking-[0.3em] text-orange-500">Milestones Reached</p>
             <StatCounter value={200} suffix="+" />
             <h2 className="mt-4 text-3xl font-semibold text-slate-950 md:text-4xl">Projects Successfully Delivered</h2>
          </motion.div>
          ...
          <div className="grid w-full grid-cols-2 gap-4 md:gap-8 lg:max-w-5xl">
            ...
            >
               <div className="absolute right-3 top-3 md:right-6 md:top-6 flex items-center gap-1">
                  ...
                  <span className="text-[8px] md:text-[10px] font-bold uppercase tracking-wider text-emerald-500">Active</span>
                </div>
               ...
               <div className="flex flex-col items-start text-left">
                  ...
                  <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-2">
                    ...
                    <span className="text-[10px] md:text-xl font-bold text-orange-500 leading-tight">Strategic Branches</span>
                  </div>
                  <div className="mt-4 hidden md:flex flex-wrap gap-2">
                    {["Gujarat", "Bihar", "Maharashtra"].map(state => (
                      <span key={state} className="rounded-full bg-orange-100 px-4 py-1.5 text-xs font-bold text-orange-600 border border-orange-200 uppercase tracking-wide">
                        {state}
                      </span>
                    ))}
                  </div>
                  <p className="mt-3 text-[10px] md:text-sm text-slate-600 italic leading-snug">Expanding our digital footprints.</p>
               </div>
            </motion.div>
            ...
            >
               <div className="flex flex-col items-start text-left">
                  <span className="text-2xl md:text-4xl mb-2 md:mb-4">💎</span>
                  <div className="flex flex-col md:flex-row md:items-baseline gap-1 md:gap-2">
                    <span className="text-3xl md:text-5xl font-bold text-slate-900">98</span>
                    <span className="text-lg md:text-2xl font-bold text-orange-500">%</span>
                  </div>
                  <h3 className="mt-1 text-xs md:text-2xl font-bold text-slate-900">Retention Rates</h3>
                  <div className="mt-4 h-1.5 md:h-2 w-full rounded-full bg-slate-100 overflow-hidden">
                    <motion.div 
                      initial={{ width: 0 }}
                  ...
                  <p className="mt-3 text-[10px] md:text-sm text-slate-600 leading-snug">Trust built through consistent delivery.</p>
               </div>
            </motion.div>
